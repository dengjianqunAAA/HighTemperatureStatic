...
namespace TDCommon
{
    public  class XmlHelper
    {
        ...
        /// <returns></returns>
        public  XmlDocument CreateXmlDocument(string name, string type)
        {
            /**************************************************
            * .net中调用方法：写入文件中,则：
            ...
            ************************************************/
            ...
            {
                TDCommom.Logs.Error("Error!"+exception);
                return null;
            }
            return xmlDocument;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public  string GetNodeInfoByNodeName(string path, string nodeName)
        {
            try
            {
                var xmlString = "";
        ...
        public  string GetNodeValue(string source, XmlType xmlType, string nodeName)
        {
            var xmlDocument = new XmlDocument();
            if (xmlType == XmlType.File)
        ...
        /// <returns>节点内容</returns>
        public  string GetNodeAttributeValue(string source, XmlType xmlType, string nodeName,
        ...
        public  object GetTableCell(string source, XmlType xmlType, string tableName, int rowIndex, string colName)
        {
            try
            {
                var dataSet = new DataSet();
        ...
        /// <returns>值，不存在时返回Null</returns>
        public  object GetTableCell(string source, XmlType xmlType, string tableName, int rowIndex, int colIndex)
        {
            try
            {
                var dataSet = new DataSet();
        ...
        public  void GetXmlValueDataSet(string xmlString, ref DataSet dataSet)
        {
            try
            {
                var xmlDocument = new XmlDocument();
        ...
        /// <returns></returns>
        public  string ReadXml(string path, string nodeName, string name) //读取XML
        {
            try
            {
                var xmlValue = "";
        ...
        public  void SaveTableToFile(DataTable dataTable, string filePath)
        {
            try
            {
        ...
        /// <param name="filePath">文件路径</param>
        public  void SaveTableToFile(DataTable dataTable, string rootName, string filePath)
        {
            try
            {
        ...
        /// <returns></returns>
        public  string SerializeToXmlStr<T>(T obj, bool omitXmlDeclaration)
        {
            try
            {
        ...
        /// <returns>更新是否成功</returns>
        public  bool UpdateTableCell(string filePath, string tableName, int rowIndex, string colName,
            string content)
        {
            bool flag;
            var dataSet = new DataSet();
        ...
        /// <param name="content">更新值</param>
        /// <returns>更新是否成功</returns>
        public  bool UpdateTableCell(string filePath, string tableName, int rowIndex, int colIndex, string content)
        {
            bool flag;
        ...
        /// <returns></returns>
        public  string WriteXML<T>(T item, string path, string jjdbh, string ends)
        {
        ...
        /// <returns></returns>
        public  T XmlFileDeserialize<T>(string path)
        {
        ...
        public  string XmlSerialize<T>(T obj, bool omitXmlDeclaration)
        {
        ...
        /// <returns>序列化后的字符串</returns>
        public  void XmlSerialize<T>(string path, T obj, bool omitXmlDeclaration, bool removeDefaultNamespace)
        {
        ...
        private  byte[] ShareReadFile(string filePath)
        {
            byte[] bytes;
