...
using TDModel.UiModel;

namespace TDUserControl
{
    /// <summary>
    /// SmallPager.xaml 的交互逻辑
    /// </summary>
    public partial class SmallPager : Border, IComponentConnector
    {
        public SmallPager()
        {
            InitializeComponent();
        ...
        protected void RaisePageNumberChangedEvent(PageNumberChangedEventArgs args)
        {
        ...
        private void PageButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (this.PageNumber == num)
                return;
            this.RaisePageNumberChangedEvent(new PageNumberChangedEventArgs()
            {
                PageNumber = num
            });
        }
