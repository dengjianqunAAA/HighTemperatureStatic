...
namespace TengDa.Plc.IPLCComm
{
    interface ITCPHandle
    {
        ...
        int ReadSingleD(Socket socket, string address);
        ...
        bool WriteSingleD(Socket socket, string address, int values);
        ...
        /// <returns></returns>
        List<string> ReadMultiD(Socket socket, string address, int number);
        ...
        /// </summary>
        /// <param name="socket">通讯对象</param>
        /// <param name="address">读取继电器地址</param>
        /// <returns></returns>
        bool ReadSingleBit(Socket socket, string address);

        /// <summary>
        /// 写单个位
        /// </summary>
        /// <param name="socket">通讯对象</param>
        /// <param name="address">写继电器地址</param>
        /// <param name="values">0=false ,1=true</param>
        /// <returns></returns>
        bool WriteSingleBit(Socket socket, string address, int values);
    }
}
